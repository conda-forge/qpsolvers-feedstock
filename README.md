...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qpsolvers-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12174&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qpsolvers-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qpsolvers` can be installed with:

```
conda install qpsolvers
```

It is possible to list all of the versions of `qpsolvers` available on your platform with:
